...
<template>
  <div>
    <header class="">
      <video autoplay="" muted="" loop="" poster="https://cdn.stolichki.ru/s/media/dermatology/video-tovar-poster.png"
        class="video">
      ...
      <div class="tw-container">
        ...
        <div class="card-big tw-mt-16 xl:tw-mt-10">
          ...
          <div class="tw-flex tw-flex-col tw-mt-7.5 tw-gap-5 xl:tw-mt-0 xl:tw-flex-row xl:tw-gap-3">
            ...
            <a class="button button_base button_black button_minw-base" href="https://t.me/algafinance" target="blank">
